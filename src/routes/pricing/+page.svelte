...
<div class="py-20">
  ...
  <div class="mx-auto mb-10 max-w-2xl text-center">
    ...
    <p class="text-lg">
      Contactly offers flexible pricing plans to cater to the unique needs of your business. Choose from our range of
  ...
  <!-- Pricing Card Grid -->
  <div class="isolate mx-auto mt-10 grid max-w-6xl grid-cols-1 justify-items-center gap-8 lg:grid-cols-3">
